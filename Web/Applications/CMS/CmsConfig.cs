...
namespace Spacebuilder.CMS
{
    ...
    public class CmsConfig : ApplicationConfig
    {
        ...
        public override void Initialize(ContainerBuilder containerBuilder)
        {
            ...
            containerBuilder.Register(c => new CmsOwnerDataGetter()).As<IOwnerDataGetter>().SingleInstance();
            containerBuilder.Register(c => new CmsCommentUrlGetter()).As<ICommentUrlGetter>().SingleInstance();
            containerBuilder.Register(c => new CmsRecommendUrlGetter()).As<IRecommendUrlGetter>().SingleInstance();
            containerBuilder.Register(c => new CommentRecommendUrlGetter()).As<IRecommendUrlGetter>().SingleInstance();
