...
namespace Spacebuilder.CMS
{
    ...
    public static class SiteUrlsExtension
    {
        ...
        /// 标签控件
        /// </summary>
        public static string _TagSelector(this SiteUrls siteUrls, long contentItemId, int contentFolderId, string titleControlName)
        {
            return CachedUrlHelper.Action("_TagSelector", "ChannelCms", CmsAreaName, new RouteValueDictionary { { "contentItemId", contentItemId }, { "contentFolderId", contentFolderId }, { "titleControlName", titleControlName } });
        }
