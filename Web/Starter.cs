...
using System;
using Fasterflect;
using Spacebuilder.Common.MobileClient;
...
namespace Spacebuilder.Environments
{
    ...
    public class Starter
    {
        ...
        private static void InitializeDIContainer()
        {
            ...
            containerBuilder.Register(c => new PageResourceManager("近乎 v4.1") { DebugEnabled = pageResourceDebugEnabled, ResourceSite = resourceSite }).As<IPageResourceManager>().InstancePerHttpRequest();
