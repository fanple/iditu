...
namespace Tunynet.Common
{
    ...
    public class ActivityService
    {
        ...
        ///<returns></returns>
        public PagingDataSet<Activity> GetMyTimeline(long userId, long? followGroupId, int? applicationId, MediaType? mediaType, bool? isOriginalThread, int pageIndex, bool? isMobileClient = false)
        {
            return activityRepository.GetMyTimeline(userId, followGroupId, applicationId, mediaType, isOriginalThread, pageIndex, isMobileClient);
        }
