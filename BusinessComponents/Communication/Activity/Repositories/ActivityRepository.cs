...
namespace Tunynet.Common.Repositories
{
    ...
    public class ActivityRepository : Repository<Activity>, IActivityRepository
    {
        ...
        ///<returns></returns>
        public PagingDataSet<Activity> GetMyTimeline(long userId, long? followGroupId, int? applicationId, MediaType? mediaType, bool? isOriginalThread, int pageIndex, bool? isMobileClient = null)
        {
            ...
            }, () =>
            {
                ...
                {
                    sql.Where("tn_Activities.ApplicationId in (@0,@1,@2)", 1001, 1002, 1012)
