...
namespace Tunynet.Common.Repositories
{
    ...
    public interface IActivityRepository : IRepository<Activity>
    {
        ...
        ///<returns></returns>
        PagingDataSet<Activity> GetMyTimeline(long userId, long? followGroupId, int? applicationId, MediaType? mediaType, bool? isOriginalThread, int pageIndex, bool? isMobileClient = null);
