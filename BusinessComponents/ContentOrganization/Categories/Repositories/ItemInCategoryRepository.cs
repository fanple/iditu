...
namespace Tunynet.Common.Repositories
{
    ...
    public class ItemInCategoryRepository : Repository<ItemInCategory>, IItemInCategoryRepository
    {
        ...
        public int ClearCategoriesFromItem(long itemId, long? ownerId, string tenantTypeId)
        {
            ...
            //组装sql
            sql.Append("select Id from tn_ItemsInCategories inner Join tn_Categories on tn_ItemsInCategories.CategoryId = tn_Categories.CategoryId where tn_ItemsInCategories.ItemId=@0 and tn_Categories.OwnerId = @1 and tn_Categories.TenantTypeId=@2", itemId, ownerId, tenantTypeId);
